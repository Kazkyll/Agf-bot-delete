...
bot.on('message', function (message) {
  if (message.content === prefixA + '03') {
    message.reply('Le testeur officiel AGF vous informe que les versions suivante pour Android: 2.16.16 - 2.16.17 - 2.16.18 sont non validée et comportent des bugs')
  }
});
